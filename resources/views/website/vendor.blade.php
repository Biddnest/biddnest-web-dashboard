            ...
            <div class="container">
                <div class="quote responsive w-70 ontop p-4 bg-white">
                    <div class="card-body">
                        ...
                        <form class="form-new-order pt-4 mt-3 onboard-vendor-form input-text-blue" action="{{route('add_vendor')}}" method="POST" data-next="redirect" data-redirect-type="hard" data-url="{{route('home')}}" data-alert="mega" data-parsley-validate>
                            <div class="row">
