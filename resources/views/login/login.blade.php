...
{{--                <img src="{{ asset('static/images/Background.png') }}" width="90%" height="100%">--}}
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <!-- Form -->
                    <form class="px-3 login" data-alert="inline" action="{{route('admin_login')}}" method="POST" onsubmit="return false;" data-next="redirect" data-redirect-type="hard" data-url="{{route('dashboard')}}" data-parsley-validate>
                        <!-- Input Box -->
