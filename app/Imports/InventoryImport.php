    ...
    */
    public function model(array $row)
    {
        return new Inventory([
            ...
            "image"=>"https://via.placeholder.com/300x300.png?text=".$row[0] && trim($row[0]) !== "" ? ucfirst(strtolower($row[0])) : "Item Id ".uniqid(),
            "icon"=>"https://via.placeholder.com/120x120.png?text=".$row[0] && trim($row[0]) !== "" ? ucfirst(strtolower($row[0])) : "Item Id ".uniqid(),
