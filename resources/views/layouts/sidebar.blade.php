<main class="dashboard grey-bg">
        <div class="menu-sidebar">
            <div class="side-nav-bar">
                ...
                <div class="nav-links">
                    <ul class="menu p-1">
                        <li class="menu-item active-menu-item"><a class="regular-nav" href="index.html"><span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-meter "></i></span> </span> Dashboard</a>
                        </li>
