                            ...
                            @foreach($users as $user)
                                <tr class="tb-border cursor-pointer user_{{$user->id}} sidebar-toggle" data-sidebar="{{ route('sidebar.user',['id'=>$user->id]) }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="delete inline-icon-button" data-parent=".user_{{$user->id}}" data-confirm="Are you sure, you want delete this User permenently? You won't be able to undo this." data-url="{{route('user_delete',['id'=>$user->id])}}"><i class="icon dripicons-trash p-1" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
