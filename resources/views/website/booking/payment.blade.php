                ...
                <div class="card-body ">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="d-flex row  justify-content-between mr-1 pl-3 ">
                            <div class="col-md-2.5  card  bg-turnblue card-methord" data-method="upi">
                            ...
                            <div class="card col-md-2.5    bg-turnblue card-methord" data-method="net-bancking">
                                <img class="mt-1" src="{{asset('static/website/images/icons/upi1.svg')}}" />
                                <p class=" center  p-2 text-white">Net Banking</p>
                            </div>
                            <div class="card col-md-2.5   bg-turnblue card-methord " data-method="debit card">
                                <img class="mt-1 pt-2" src="{{asset('static/website/images/icons/upi2.svg')}}" />
                                <p class=" center p-2 text-white">Debit Card</p>
                            </div>
                            <div class="card col-md-2.5   bg-turnblue card-methord " data-method="credit card">
                    ...
                    <div style="float: right;" class="btn-proceed mr-2 mt-2 ">
                        <a href="{{route('my-bookings')}}">
                            <button type="submit" class="btn btn-theme-bg  white-bg">Proceed</button>
                        </a>
                    </div>
                </div>
            </div>
