                            ...
                            @foreach($vouchers as $voucher)
                                <tr class="tb-border cursor-pointer coup_{{$voucher->id}} sidebar-toggle" {{--data-sidebar="{{ route('sidebar.coupon',['id'=>$voucher->id]) }}"--}}>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" style="display: table-cell; transform: translate(16px, 0px);" class="delete inline-icon-button ml-4" data-parent=".coup_{{$voucher->id}}" data-confirm="Are you sure, you want delete this Coupon permanently? You won't be able to undo this." data-url="{{route('coupon_delete',['id'=>$voucher->id])}}"><i class="icon dripicons-trash p-1" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
