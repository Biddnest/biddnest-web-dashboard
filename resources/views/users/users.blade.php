                        ...
                        <tbody class="mtop-20 f-13">
                            @foreach($users as $user)
                                <tr class="tb-border cursor-pointer user_{{$user->id}} sidebar-toggle" data-sidebar="{{ route('sidebar.user',['id'=>$user->id]) }}">
                                    ...
                                    <td>
                                        <a  class = "inline-icon-button" href="{{route('edit-users', ["id"=>$user->id])}}"><i class="icon dripicons-pencil p-1 mr-2" aria-hidden="true"></i></a>
                                        <a href="#" class="delete inline-icon-button" data-parent=".user_{{$user->id}}" data-confirm="Are you sure, you want delete this Organization permenently? You won't be able to undo this." data-url="{{route('user_delete',['id'=>$user->id])}}"><i class="icon dripicons-trash p-1" aria-hidden="true"></i></a>
                    ...
                    @if(count($users)== 0)
                        <div class="row hide-on-data">
                            <div class="col-md-12 text-center p-20">
                                <p class="font14"><i>. You don't have any Users here.</i></p>
                            </div>
                        </div>
                    @endif
