            ...
            <div class="quote p-0 br-5 w-70 ontop bg-white responsive">
                <div class="row">
                    <div class="col-3 p-4 bg-gray-circle border-right border-l-radius">
                        ...
                        <a href="{{route('terms.page', ["slug"=>"terms-and-conditions"])}}"><div class="d-flex mt-1 pt-3" style="align-items: baseline;"><h4 class="icon bg-purple cursor-pointer text-white">2</h4><p class="theme-text" > Terms and Conditions</p></div></a>
                        <a href="{{route('terms.page', ["slug"=>"privacy-policies"])}}"><div class="d-flex mt-1 pt-3" style="align-items: baseline;"><h4 class="icon bg-purple cursor-pointer text-white">3</h4><p class="theme-text">Privacy and Policy</p></div></a>
