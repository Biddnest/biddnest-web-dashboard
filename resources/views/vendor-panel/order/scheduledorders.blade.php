...
@section('body')
    <div class="main-content grey-bg" data-barba="container" data-barba-namespace="order_scheduled">
                        ...
                        <div class="card-head right text-left">
                            <h3 class=" f-18 pb-0">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link active p-15 hide-cards" id="scheduled-tab" data-toggle="tab"
                                           href="#scheduled" role="tab" aria-controls="profile"
                                           aria-selected="false">Scheduled Orders</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="tab-pane fade show active" id="scheduled" role="tabpanel"
                            ...
                            <table class="table text-left p-0  theme-text ">
                                ...
                                <tr>
                                    ...
                                    <th scope="col"> <b>Order Status</b> <i
