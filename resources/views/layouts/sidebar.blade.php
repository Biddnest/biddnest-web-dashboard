                ...
                <div class="nav-links">
                    <ul class="menu p-1">
                        ...
                        <li class="menu-item b-purple" data-toggle="#booking" href="#Booking" role="button"
                            aria-expanded="false" aria-controls="Booking"> <a class=""><span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-to-do "></i></span> </span> Booking</a>
                        </li>
                        ...
                        <li class="menu-item b-purple" data-toggle="#vendors" href="#Vendors" role="button"
                            aria-expanded="false" aria-controls="Vendors"> <a class=""> <span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-store "></i></span> </span> Vendors</a>

                        </li>
                        <!-- vendor sublink -->
                        <ul class="sub-menu vendor" id="vendors">
                            <li class="sub-menu-item"><a href="{{route('create-vendors')}}"><i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i> Create</a></li>
                            <li class="sub-menu-item"><a href="{{route('vendors')}}"><i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i>All</a></li>
...
{{--                                    Vendors</a></li>--}}
                            <li class="sub-menu-item"> <a href="{{route('verified-vendors')}}"><i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i> Verified</a></li>
                        </ul>
                        <li class="menu-item" data-toggle="" href="#Customer" role="button" aria-expanded="false"
                            aria-controls="Customer"> <a class=""> <span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-user"></i></span> </span>Customers</a>
                        </li>
                        <!-- sublinks -->
                        ...
                        <li class="menu-item" data-toggle="" href="#Categories" role="button" aria-expanded="false"
                            aria-controls="Categories"><a class=""> <span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-view-thumb"></i></span> </span>Service</a>
                        </li>
                        <!-- sublinks -->
                        <ul class="sub-menu" id="Categories">
                            <li class="sub-menu-item"><a href="{{route('categories')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i>Category</a>
                            </li>
                        ...
                        <li class="menu-item" data-toggle="" href="#Coupons" role="button" aria-expanded="false"
                            aria-controls="Coupons"><a class=""> <span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-ticket"></i></span> </span></i> Coupons</a>
                        </li>
                        <!-- sublinks -->
                        ...
                        <li class="menu-item" data-toggle="" href="#Zone" role="button" aria-expanded="false"
                            aria-controls="Zone"><a class=""> <span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-location "></i></span> </span> Zones</a>
                        </li>
                        <!-- sublinks -->
                        <ul class="sub-menu" id="Zone">
                            ...
                            <li class="sub-menu-item"><a href="{{route('create-zones')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i> Create</a>
                            </li>
                        ...
                        <li class="menu-item" data-toggle="" href="#Sliders" role="button" aria-expanded="false"
                            aria-controls="Sliders"><a class=""><span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-photo-group"></i></span> </span> Promotions</a>
                        </li>
                        <!-- sublinks -->
                        <ul class="sub-menu" id="Sliders">
                            <li class="sub-menu-item"><a href="{{route('slider')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i>Sliders</a></li>
                            <li class="sub-menu-item"><a href="{{route('push-notification')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i>Push Notifications</a>
                            </li>
                        ...
                        <li class="menu-item" data-toggle="" href="#reviews" role="button" aria-expanded="false"
                            aria-controls="Reviews"><a class=""><span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-star"></i></span> </span>Reviews</a>
                        </li>
                        ...
                        <ul class="sub-menu" id="Payout">
                            <li class="sub-menu-item"><a href="{{route('vendor-payout')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i>Payouts</a>
                            </li>
                        ...
                        <li class="menu-item" data-toggle="" href="#Users" role="button" aria-expanded="false"
                            aria-controls=" Users"><a class=""> <span class="side-nac-icon"><span class="icon-sidebar"><i class="icon dripicons-user-group"></i></span> </span> Dashboard Access</a>
                        </li>
                        <!-- sublinks -->
                        <ul class="sub-menu" id="Users">
                            <li class="sub-menu-item"><a href="{{route('users')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i>All Users</a>
                            </li>
                            <li class="sub-menu-item"><a href="{{route('create-users')}}"> <i
                                        class="fa fa-dot-circle-o icons-space mr-2" aria-hidden="true"></i> Create User</a>
                            </li>
