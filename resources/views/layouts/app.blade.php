    ...
    <body>
        <main class="dashboard grey-bg">
           ...
           <div class="side-bar-pop-up h-100" id="inventory">
            ...
            <!-- Zones Pop-up -->
            <div class="side-bar-pop-up" id="zones">
                <div class="modal-header pb-0 border-none">
                    <h3 class="f-14">
                        <ul class="nav nav-tabs pt-20 p-0 " id="myTab" role="tablist">
                            <li class="nav-item">
            ...
            <!-- slider Pop-up -->
            <div class="side-bar-pop-up h-100" id="slider">
                <div class="modal-header pb-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="row d-flex  pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                            <h1 class="side-popup-heading">Banner ID</h1>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content"> B123456</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                            <h1 class="side-popup-heading">Slide ID</h1>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content">SL123345</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                            <h1 class="side-popup-heading">Coupon ID</h1>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content">C1234566</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                            <h1 class="side-popup-heading">Zone ID</h1>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content">Z0912344</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                            <h1 class="side-popup-heading">Date</h1>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content">23 Dec 20</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                        ...
                        <div class="col-lg-6 d-flex align-items-center">
                            <h1 class="side-popup-heading">Center</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                        ...
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content"> 600 X 240 Px</h1>
                        </div>
                    </div>
                    <div class="row d-flex pb-4 pl-3">
                        <div class="col-lg-6 align-items-center">
                            <h1 class="side-popup-heading">Created By</h1>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <h1 class="side-popup-content">E1237489</h1>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center p-20">
                        <!-- <div class="">
            ...
            <div class="side-bar-pop-up">
                <div class="modal-header">
                    <div class="theme-text heading f-14">Review & Ratings </div>
                    <button type="button" class="close theme-text" data-dismiss="modal" aria-label="Close"
                        onclick="$('.side-bar-pop-up').toggleClass('display-pop-up');">
                        <!-- <span aria-hidden="true" >&times;</span> -->
                        <i class="fa fa-times theme-text" aria-hidden="true"></i>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active margin-topneg-15" id="customer" role="tabpanel"
                            ...
                            <div class="d-flex   justify-content-center p-100">
                                ...
                                <!-- <div class=""><a class="white-text p-10"></a><button class="btn theme-bg white-text">View
                                        More</button></a></div> -->
                ...
                <div class="modal-body">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active margin-topneg-15" id="customer" role="tabpanel"
                            aria-labelledby="new-order-tab">
                            <!-- form starts -->
                            <div class="d-flex  row mt-2 p-10">
                            ...
                            <div class="d-flex  row  p-10">
                                ...
                                <div class="col-sm-6">
                                    <div class="theme-text f-14 status-badge">
                                        Viewed
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="for-friend" tabindex="-1" role="dialog" aria-labelledby="for-friend" aria-hidden="true">
             ...
             <!-- vendor Payout Pop-up -->
            <div class="side-bar-pop-up">
                <div class="modal-header">
                <div class="theme-text heading f-18">Vendor Payout</div>
                    <button type="button" class="close theme-text" data-dismiss="modal" aria-label="Close"
                        onclick="$('.side-bar-pop-up').toggleClass('display-pop-up');">
                        <!-- <span aria-hidden="true" >&times;</span> -->
                        <i class="fa fa-times theme-text" aria-hidden="true"></i>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active margin-topneg-15" id="customer" role="tabpanel"
                            ...
                            <div class="d-flex   justify-content-center p-10">
                                ...
                                <div class=""><a class="white-text p-10" href="{{route('payout-details')}}"><button
                                            class="btn theme-bg white-text">View More</button></a></div>
