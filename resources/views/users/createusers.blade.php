                            ...
                            <div class="d-flex row p-20">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-input">
                                        ...
                                        <input type="text" id="fullname" placeholder="btech Mechanical" name="meta[pan_no]" class="form-control" value="@if($users){{substr(json_decode($users->meta, true)['pan_no'], 0, 4).str_repeat("X", strlen(json_decode($users->meta, true)['pan_no'])-4)}}@endif" required>
                                        <span class="error-message">Please enter valid</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-input">
                                        ...
                                        <input type="text" id="fullname" name="meta[adhar_no]" placeholder="btech Mechanical" class="form-control" value="@if($users){{substr(json_decode($users->meta, true)['aadha_no'], 0, 4).str_repeat("X", strlen(json_decode($users->meta, true)['aadha_no'])-4)}}@endif" required>
                                        <span class="error-message">Please enter valid</span>
                                    </div>
                                </div>
