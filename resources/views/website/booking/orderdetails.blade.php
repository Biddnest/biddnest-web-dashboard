                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="">
                                                <div class="pr-3">
                                                    ...
                                                    <p class="mt-0 f-14  p-0 text-right">@if($booking->movement_specifications){{json_decode($booking->movement_specifications->meta, true)['min_man_power']}} - {{json_decode($booking->movement_specifications->meta, true)['max_man_power']}}@else N/A @endif</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
