...
class BookingsController extends Controller
{
    ...
    public static function bookingHistoryEnquiry($user_id, $web=false)
    {
        ...
        $bookingorder = Booking::where(["deleted" => CommonEnums::$NO,
            "user_id" => $user_id])
            ->whereIn("status", [BookingEnums::$STATUS["enquiry"], BookingEnums::$STATUS["placed"]])
            ->with('movement_dates')
//            ->with('inventories')
//            ->with('status_history')
            ->with('service')
    ...
    public static function bookingHistoryPast($user_id, $web=false)
    {
        $bookingorder = Booking::where(["deleted" => CommonEnums::$NO,
            "user_id" => $user_id])
            ->whereIn("status", [BookingEnums::$STATUS["enquiry"], BookingEnums::$STATUS["placed"], BookingEnums::$STATUS["cancelled"], BookingEnums::$STATUS['completed']])
            ->orderBy('id', 'DESC')
            ->with('movement_dates')
    ...
    public static function bookingHistoryLive($user_id, $web=false)
    {
        $bookingorder = Booking::where(["deleted" => CommonEnums::$NO,
            "user_id" => $user_id])
            ->whereNotIn("status", [BookingEnums::$STATUS["enquiry"], BookingEnums::$STATUS["placed"], BookingEnums::$STATUS["cancelled"], BookingEnums::$STATUS['completed']])
            ->with('movement_dates')
//            ->with('inventories')
//            ->with('status_history')
            ->with('service')
