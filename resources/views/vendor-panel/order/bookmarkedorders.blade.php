...
@section('body')
    <div class="main-content grey-bg" data-barba="container" data-barba-namespace="order_save">
            ...
            <div class="col-sm-12">
                ...
                <div class="card  h-auto p-0 pt-10">
                        ...
                        <div class="card-head right text-left">
                            <h3 class=" f-18 pb-0">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link active p-15 hide-cards" id="savedorders-tab" data-toggle="tab"
                                           href="#savedorders" role="tab" aria-controls="profile"
                                           aria-selected="false">Saved Orders </a>
                                    </li>
                                </ul>
                            </h3>
                    ...
                    <div class="tab-content margin-topneg-42" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="savedorders" role="tabpanel"
