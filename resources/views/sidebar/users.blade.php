                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active " id="details" role="tabpanel"
                            ...
                            <div class="d-flex   justify-content-center p-10">
                                ...
                                <div class=""><a class="white-text p-10" href="{{route('details-users')}}"><button
                        ...
                        aria-labelledby="zone-insight-tab">
                        <div class="d-flex  row  p-10">
                        ...
                        <div class="d-flex   justify-content-center p-10">
                            ...
                            <div class=""><a class="white-text p-10" href="{{route('details-users')}}"><button class="btn theme-bg white-text">View More</button></a></div>
