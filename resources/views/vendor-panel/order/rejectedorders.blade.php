            ...
            <div class="page-head text-left  pt-0 pb-0 p-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Rejected Enquiries</li>
                    ...
                    <div class="header-wrap">
                        <h3 class="f-18 mt-0 ml-1 mb-0 theme_text">
                            <ul class="nav nav-tabs pt-10 p-0" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link p-15"  href="{{route('vendor.pastbookings', ['type'=>"past"])}}">Expired Enquiries</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-15 active" id="quotation" href="{{route('vendor.rejectbookings', ['type'=>"rejected"])}}" >Rejected Enquiries</a>
                                </li>
                            </ul>
                        </h3>
