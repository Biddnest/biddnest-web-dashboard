...
<html lang="en">
    ...
    <body>
        ...
        <div class="banner-carousel-container">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner carousel-images">
                    <div class="item active">
                        <img src="{{ asset('static/website/images/images/header-image.png')}}" class="color-overlay" alt="BannerImage1" style="width: 100%" />
                    </div>
                    <div class="item">
                        <img src="{{ asset('static/website/images/images/header-image.png')}}" class="color-overlay" alt="BannerImage2" style="width: 100%" />
                    </div>
                    <div class="item">
                        <img src="{{ asset('static/website/images/images/header-image.png')}}" class="color-overlay" alt="BannerImage3" style="width: 100%" />
                    </div>
                </div>
            ...
            <div class="intro-container">
                <div class="intro-text pb-10">
                    <h1 class="text-center view-small mb-2">New Year Offer</h1>
                    <p class="mb-4 ml-2 ">
                ...
                <div class="row ml-22 mr-16 mb-2 mt-1 box-item">
                    <div class="card top-header-card col-md-4 col-xs-12">
                        <div class="card-body" data-toggle="modal" data-target="#from_location">
                            <p>FROM</p>
                            <input class="input-overwrite text-heading book-address mb-0" placeholder="SMR Apartments ">
                            <input class="input-overwrite small-heading text-heading book-address mb-1 mt-0" placeholder="Mahadevapura, Bangalore">
                        </div>
                    </div>
                    <div class="card top-header-card col-md-4 col-xs-12">
                        <div class="card-body" data-toggle="modal" data-target="#to_location">
                            <p>TO</p>
                            <input class="input-overwrite text-heading book-address mb-0" placeholder="Majestic Villas">
                            <input class="input-overwrite small-heading text-heading book-address mb-1 mt-0" placeholder="Gandhinagar, Chennai">
                    ...
                    <div class="col-lg-6 col-xs-12 tab">
                        <button class="tablinks vendor " onclick="openContent(event, 'content_accurate')" id="defaultOpen">
                            <span class="svg-container ml-2">
                                <svg class="icon-svg" id="XMLID_386_" xmlns="http://www.w3.org/2000/svg" width="57.789"
                                     height="55.473" viewBox="0 0 57.789 55.473">
                                    <path id="XMLID_389_"
                                          d="M57.678,40.668A22.781,22.781,0,0,0,39.962,20.691V17.824a3.837,3.837,0,0,0-.926-7.562H30.91a3.838,3.838,0,0,0-.926,7.562V20.7a22.664,22.664,0,0,0-11.115,6.114,22.908,22.908,0,0,0-1.916,2.175c-.028,0-.057,0-.086,0H8.823a1.129,1.129,0,1,0,0,2.257h6.593a22.627,22.627,0,0,0-2,4.338H1.129a1.129,1.129,0,1,0,0,2.257H12.775a22.949,22.949,0,0,0-.56,4.338H7.224a1.129,1.129,0,0,0,0,2.257h5.027a22.916,22.916,0,0,0,.7,4.338H5.644a1.129,1.129,0,0,0,0,2.257h8.033a22.8,22.8,0,0,0,19.06,14.6q1.118.11,2.237.11a22.855,22.855,0,0,0,12.443-3.677,1.129,1.129,0,1,0-1.232-1.892,20.542,20.542,0,1,1,6.05-6.058,1.129,1.129,0,1,0,1.893,1.229A22.873,22.873,0,0,0,57.678,40.668ZM29.329,14.1a1.582,1.582,0,0,1,1.58-1.58h8.127a1.58,1.58,0,1,1,0,3.16H30.91A1.582,1.582,0,0,1,29.329,14.1Zm2.911,6.212V17.937h5.464v2.37A23,23,0,0,0,32.241,20.311Z"
                                          transform="translate(0 -10.262)" />
                                    <path id="XMLID_391_"
                                          d="M436.9,425.5a1.129,1.129,0,1,0,.8.331A1.135,1.135,0,0,0,436.9,425.5Z"
                                          transform="translate(-386.584 -378.632)" />
                                    <path id="XMLID_394_"
                                          d="M172.382,144.609a17.51,17.51,0,1,0,17.51,17.51A17.529,17.529,0,0,0,172.382,144.609Zm0,32.762a15.252,15.252,0,1,1,15.252-15.252A15.269,15.269,0,0,1,172.382,177.371Z"
                                          transform="translate(-137.392 -129.445)" />
                                    <path id="XMLID_397_"
                                          d="M270.154,219.742l-5.59,5.59a3.5,3.5,0,0,0-3.1,0l-2.5-2.5a1.129,1.129,0,0,0-1.6,1.6l2.5,2.5a3.507,3.507,0,1,0,6.291,0l5.426-5.426h0l.164-.164a1.129,1.129,0,0,0-1.6-1.6Zm-7.14,9.986a1.25,1.25,0,1,1,1.25-1.25A1.251,1.251,0,0,1,263.014,229.728Z"
                                          transform="translate(-228.024 -195.804)" />
                                    <path id="XMLID_398_"
                                          d="M399.829,289.86h-1.046a1.129,1.129,0,0,0,0,2.257h1.046a1.129,1.129,0,1,0,0-2.257Z"
                                          transform="translate(-352.771 -258.302)" />
                                    <path id="XMLID_399_"
                                          d="M195.256,289.616h-1.046a1.129,1.129,0,1,0,0,2.257h1.046a1.129,1.129,0,1,0,0-2.257Z"
                                          transform="translate(-171.289 -258.085)" />
                                    <path id="XMLID_400_"
                                          d="M301.252,186.122a1.129,1.129,0,0,0,1.129-1.129v-1.046a1.129,1.129,0,0,0-2.257,0v1.046A1.129,1.129,0,0,0,301.252,186.122Z"
                                          transform="translate(-266.248 -163.342)" />
                                    <path id="XMLID_424_"
                                          d="M301.008,387.393a1.129,1.129,0,0,0-1.129,1.129v1.046a1.129,1.129,0,0,0,2.257,0v-1.046A1.129,1.129,0,0,0,301.008,387.393Z"
                                          transform="translate(-266.031 -344.826)" />
                                    <path id="XMLID_425_"
                                          d="M1.129,351.44a1.129,1.129,0,1,0,.8,1.927,1.129,1.129,0,0,0-.8-1.927Z"
                                          transform="translate(0 -312.931)" />
                                </svg>
                            </span>
                            <span class="ml-2"> Accurate report and fast execution</span>
                        </button>
                        <button class="tablinks vendor bg-white border-cards" onclick="openContent(event, 'content_cost')">
                            <span class="svg-container ml-2">
                                <svg class="icon-svg" id="Group_14549" data-name="Group 14549"
                                     xmlns="http://www.w3.org/2000/svg" width="55.469" height="55.473"
                                     viewBox="0 0 55.469 55.473">
                                    <g id="profit">
                                        <path id="Path_9002" data-name="Path 9002"
                                              d="M207.583,348.167a1.083,1.083,0,1,0-1.083-1.083A1.084,1.084,0,0,0,207.583,348.167Zm0,0"
                                              transform="translate(-184.181 -308.513)" />
                                        <path id="Path_9003" data-name="Path 9003"
                                              d="M.817,42.154l13,13a1.083,1.083,0,0,0,1.532,0L22.5,48a1.083,1.083,0,0,0,0-1.532l-.317-.317H37.8a5.405,5.405,0,0,0,3.69-1.451L54.636,32.385a4.183,4.183,0,0,0-5.063-6.612l-2.918,1.915A18.218,18.218,0,0,0,38.2,12.732,3.256,3.256,0,0,0,36.763,7.5c-.053-.018-.107-.033-.16-.05l2.789-5.01A1.083,1.083,0,0,0,38.748.876a22.215,22.215,0,0,0-12.356,0,1.083,1.083,0,0,0-.644,1.568l2.789,5.01-.163.051a3.25,3.25,0,0,0-1.43,5.227c-4.959,2.861-8.459,9.189-8.459,15,0,.159,0,.315.009.471a13.314,13.314,0,0,0-5.262,2.822L9.94,33.91,9.5,33.471a1.083,1.083,0,0,0-1.532,0L.817,40.622a1.083,1.083,0,0,0,0,1.532ZM28.326,2.62a20.094,20.094,0,0,1,8.488,0L34.4,6.957a13.21,13.21,0,0,0-3.659,0Zm.725,6.943a11.211,11.211,0,0,1,7.035,0,1.084,1.084,0,0,1-.271,2.112,10.6,10.6,0,0,0-6.491,0h0a1.083,1.083,0,0,1-.273-2.109Zm.6,4.285a8.454,8.454,0,0,1,5.708-.046c5.034,1.731,9.129,7.982,9.129,13.934a10.428,10.428,0,0,1-.094,1.435l-5.208,3.417a4.308,4.308,0,0,0-3.365-1.6c-2.651-.065-2.331.128-4.694,0-.532,0-.772-.347-1.147-.59A13.292,13.292,0,0,0,20.653,27.8c0-.023,0-.045,0-.069C20.652,21.867,24.689,15.638,29.65,13.848ZM14.659,32.66a11.141,11.141,0,0,1,14.019-.529,3.842,3.842,0,0,0,2.447,1.023H35.82a2.167,2.167,0,1,1,0,4.334H28.236a1.083,1.083,0,0,0,0,2.167H35.82a4.33,4.33,0,0,0,4.27-5.069L50.73,27.605a2.016,2.016,0,0,1,2.428,3.2L40.014,43.119a3.241,3.241,0,0,1-2.212.869H20.017l-8.542-8.542ZM8.734,35.769,20.2,47.238l-5.619,5.619L3.116,41.388Zm0,0"
                                              transform="translate(-0.5)" />
                                    </g>
                                    <path id="Path_12802" data-name="Path 12802"
                                          d="M349.64,257.12h-1.22a1.166,1.166,0,0,1-1.165-1.165.68.68,0,1,0-1.36,0,2.528,2.528,0,0,0,2.455,2.523v1.505a.68.68,0,0,0,1.36,0v-1.505a2.528,2.528,0,0,0,2.455-2.523v-.941a2,2,0,0,0-1.389-1.912l-3.072-1a.648.648,0,0,1-.449-.618v-1.348a.947.947,0,0,1,.946-.946h1.658a.947.947,0,0,1,.946.946.68.68,0,0,0,1.36,0,2.309,2.309,0,0,0-2.306-2.306h-.149v-1.5a.68.68,0,1,0-1.36,0v1.5H348.2a2.309,2.309,0,0,0-2.306,2.306v1.348a2,2,0,0,0,1.389,1.911l3.072,1a.648.648,0,0,1,.449.618v.941A1.166,1.166,0,0,1,349.64,257.12Z"
                                          transform="translate(-317.236 -230.98)" />
                                </svg>
                            </span>
        ...
        <section id="refer-earn" class="refer-earn p-10 mt-3 mb-10">
            <div class="container">
        ...
        <section id="get-app">
            <div class="container mt-6 text-view-center">
