...
class ApiRouteController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        if($validation->fails())
            ...
            return UserController::update($request->token_payload->id, $formatedRequest->fname, $formatedRequest->lname, $formatedRequest->email, $formatedRequest->gender, $formatedRequest->dob, $request->avatar, $request->city, null);
