                            ...
                            <div class="d-flex flex-row justify-content-center Dashboard-lcards ">
                                <div class="col-lg-10">
                                    <div class="card h-auto p-0 pt-10">
                                        ...
                                        <form class="form-new-order pt-4 onboard-vendor-form input-text-blue">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-input">
                                                        ...
                                                        <span class="">
                                                            ...
                                                            <span class="error-message">Please enter
                                                                Active/Inactive
                                                            </span>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="d-flex row p-20">
                                                <div class="col-lg-6">
                                                    <div class="form-input">
                                                        ...
                                                        <span class="">
                                                            <input type="text" placeholder="Manoj" id="constomer-name"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-input">
                                                        ...
                                                        <span class="">
                                                            <input type="text" placeholder="Chennai" id="customer-desig"
                                                                class="form-control br-5" />
                                                            <span class="error-message">please enter valid
                                                                Designation</span>
                                                        </span>
